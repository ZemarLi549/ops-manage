<template>
  <div>
    ...
    >
      ...
      >
        <a-form-item label="服务名" name="app">
          <a-input v-model:value="formState.app" allow-clear placeholder="请输入app服务名" />
        </a-form-item>
...
<script>
  ...
  import { getDataListByPage, createData, deleteData, updateData } from '@/api/log/app';
